...
kepala = Image.open('header.png')
st.image(kepala, caption=' ')
...
st.image(person, caption=' ')
#! count()
st.subheader("1. COUNT")
from PIL import Image
gambar = Image.open('gambar1.png')
st.image(gambar, caption='Python Count')
...
from PIL import Image
gambar2 = Image.open('gambar2.png')
st.image(gambar2, caption='Python Cycle')
...
from PIL import Image
gambar3 = Image.open('gambar3.png')
st.image(gambar3, caption='Python Repeat')
...
from PIL import Image
gambar4 = Image.open('gambar4.png')
st.image(gambar4, caption='Python Accumulate')
...
from PIL import Image
gambar5 = Image.open('gambar5.png')
st.image(gambar5, caption='Python Chain')
...
from PIL import Image
gambar6 = Image.open('gambar6.png')
st.image(gambar6, caption='Python Compress')
...
from PIL import Image
gambar7 = Image.open('gambar7.png')
st.image(gambar7, caption='Python Combinations')
...
from PIL import Image
gambar8 = Image.open('gambar8.png')
st.image(gambar8, caption='Python Permutations')
...
from PIL import Image
gambar9 = Image.open('gambar9.png')
st.image(gambar9, caption='Python Groupby')
...
st.write("Program diatas bertujuan untuk memgroupkan data mahasiswa berdasarkan matakuliah yang diambil. Fungsi diatas membantu untuk memgroupkan data berdasarkan kriteria tertentu, 'yaitu lambda x: x[0]' lambda function yang menerima satu argument (x) dan mengembalikan x[0], yaitu kode matakuliah.")
st.write("Data 'mahasiswa' dalam bentuk list of tuple dimana masing-masing tuple memuat informasi matakuliah dan nama mahasiswa. Kemudian data tersebut diolah dengan fungsi 'itertools.groupby' yang membandingkan elemen dalam list berdasarkan lambda function, yaitu dengan key berupa matakuliah 'nama_mahasiswa = {mk : [nama for _, nama in group]}' yang diambil (elemen pertama dari setiap tuple).")
st.write("Output dari program adalah sebuah dictionary yang memuat nama mahasiswa yang diambil masing-masing matakuliah, yang dicetak pada layar.")
st.write("")
st.text("Output Program")
